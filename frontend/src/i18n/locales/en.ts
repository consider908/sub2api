export default {
  ...
  imageWorkbench: {
    ...
    description: 'Use an API key from an OpenAI group with image generation enabled to call the image generation and edit gateways directly.',
    eyebrow: 'OpenAI image gateway',
    parameters: 'Parameters',
    parametersHint: 'Choose a key, model, and output settings. Reference images switch the request to edit mode automatically.',
    apiKey: 'API Key',
    selectKey: 'Select an available key',
    model: 'Model',
    size: 'Size',
    count: 'Count',
    quality: 'Quality',
    ...
    prompt: 'Prompt',
    promptPlaceholder: 'Example: cinematic product poster, clean background, soft key light, premium commercial photography.',
    ...
    editButton: 'Generate from references',
    generating: 'Generating...',
    results: 'Result canvas',
    resultSummaryEmpty: 'Generated images will appear here.',
    resultSummary: '{count} images generated in this run.',
    generatingSummary: 'Waiting for the gateway to return images.',
    emptyCanvasTitle: 'No results yet',
    emptyCanvasDescription: 'Enter a prompt and select an available key to start generating.',
    selected: 'Selected',
    select: 'Select',
    download: 'Download',
    copyPrompt: 'Copy prompt',
    iteration: 'Iteration',
    iterationHint: 'Select a result to reuse the revised prompt or use it as the next reference image.',
    revisedPrompt: 'Model revised prompt',
    noRevisedPrompt: 'No revised prompt was returned.',
    usePrompt: 'Use prompt',
    setReference: 'Set as reference',
    remixActions: 'Remix actions',
    remixVariation: 'Detail variation',
    remixVariationDescription: 'Keep the subject and composition while exploring angle, texture, and lighting changes.',
    remixVariationInstruction: 'Generate detail variations while preserving the subject, composition, and core style. Adjust angle, material texture, and lighting depth.',
    remixProduct: 'Commercial polish',
    remixProductDescription: 'Improve product readability, crisp edges, and premium commercial texture.',
    remixProductInstruction: 'Optimize the image for commercial display with stronger subject silhouette, material detail, clean background, and premium lighting.',
    remixBackground: 'Replace background',
    remixBackgroundDescription: 'Keep the subject while redesigning the background space and mood.',
    remixBackgroundInstruction: 'Keep the subject appearance and proportions, redesign the background space, make the image cleaner and more layered, and preserve realistic light matching.',
    noSelectionTitle: 'Select a result image',
    noSelectionDescription: 'Once selected, you can copy the prompt, set it as a reference, or apply a remix action.',
    recentHistory: 'Recent generations',
    clearHistory: 'Clear history',
    noKeyTitle: 'No image-capable API key available',
    noKeyDescription: 'Only active keys from OpenAI groups with image generation enabled are shown. Create one or switch to an eligible group.',
    ...
    referenceSet: 'Reference image set',
    referenceSetFailed: 'Failed to set reference image',
    unsupportedType: '{name} is not a supported image type',
    tooLarge: '{name} exceeds {maxMB}MB',
    fileValidationFailed: 'Reference image validation failed'
  },
  ...
  usage: {
    ...
    errors: {
      ...
      cleanupConfirmTitle: 'Clear error requests',
      cleanupConfirmMessage: 'Clear error requests matching the current filters and selected time range?',
      cleanupSuccess: 'Cleared {count} error requests',
      cleanupFailed: 'Failed to clear error requests',
      categories: {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Upload a sub2api export JSON file to import accounts and proxies in bulk.',
      dataImportWarning: 'Import will create new accounts and proxies. Files may contain sensitive credentials; groups must be bound manually, and existing data conflicts are not resolved automatically.',
      ...
      types: {
        ...
        kiroOauth: 'Google / GitHub / AWS Builder ID / Import',
      ...
      kiroCreditUnitPriceUsd: 'Kiro Credit Unit Price',
      kiroCreditUnitPriceUsdHint: 'Used only to estimate today\'s Kiro Credits cost. Set 0 to hide the estimated amount.',
      expiresAt: 'Expires At',
      ...
      oauth: {
        ...
        kiro: {
          ...
          oauthSubtitle: 'Authorize Kiro in the browser',
          oauthProviderTitle: 'Sign-In Method',
          ...
          clientIdPlaceholder: 'Paste IDC client_id',
          clientSecretLabel: 'Client Secret',
          clientSecretPlaceholder: 'Paste IDC client_secret',
          idcRefreshTokenHint: 'IDC Refresh Token validation also requires the client_id and client_secret from device registration. Start URL and Region are submitted with the request.',
          ...
          refreshTokenAuth: 'Manual RT',
          refreshTokenDesc: 'Enter your existing Kiro Refresh Token. Supports batch input (one per line). The system will validate it and create OAuth accounts.',
          refreshTokenPlaceholder: 'Paste your Kiro Refresh Token...\nSupports multiple tokens, one per line',
          validating: 'Validating...',
          validateAndCreate: 'Validate & Create',
          pleaseEnterRefreshToken: 'Please enter Refresh Token',
          pleaseEnterClientId: 'Please enter IDC Client ID',
          pleaseEnterClientSecret: 'Please enter IDC Client Secret',
          failedToValidateRT: 'Failed to validate Refresh Token'
        }
      },
