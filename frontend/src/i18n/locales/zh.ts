export default {
  ...
  imageWorkbench: {
    title: '生图工作台',
    description: '使用已开通生图功能的 OpenAI 分组 API Key，直接调用图片生成与图片编辑网关。',
    eyebrow: 'OpenAI 图片网关',
    parameters: '参数面板',
    parametersHint: '选择 Key、模型和输出规格，带参考图时自动切换为编辑流。',
    apiKey: 'API Key',
    selectKey: '选择可用 Key',
    model: '模型',
    size: '尺寸',
    ...
    background: '背景',
    prompt: 'Prompt',
    promptPlaceholder: '例如：电影感产品海报，干净背景，柔和主光，高级商业摄影质感。',
    referenceImages: '参考图',
    uploadReference: '上传参考图',
    uploadHint: 'PNG、JPG、WEBP，单张不超过 10MB',
    clearReferences: '清空',
    ...
    generating: '生成中...',
    results: '结果画布',
    resultSummaryEmpty: '生成结果会显示在这里。',
    resultSummary: '本次生成 {count} 张图片。',
    generatingSummary: '正在等待网关返回图片。',
    emptyCanvasTitle: '暂无生成结果',
    emptyCanvasDescription: '填写 Prompt 并选择可用 Key 后即可开始生成。',
    selected: '已选中',
    select: '选中',
    download: '下载',
    copyPrompt: '复制 Prompt',
    iteration: '迭代面板',
    iterationHint: '选择结果图后，可复用改写 Prompt 或设为下一轮参考图。',
    revisedPrompt: '模型改写 Prompt',
    noRevisedPrompt: '模型未返回改写 Prompt。',
    usePrompt: '使用改写',
    setReference: '设为参考图',
    remixActions: '二创动作',
    remixVariation: '细节变体',
    remixVariationDescription: '保留主体与构图，探索角度、质感和光线变化。',
    remixVariationInstruction: '在保留主体、构图和核心风格的前提下，生成一组细节变体，调整角度、材质质感和灯光层次。',
    remixProduct: '商业强化',
    remixProductDescription: '提升产品可读性、边缘清晰度和高级商业质感。',
    remixProductInstruction: '将画面优化为更适合商业展示的版本，强化主体轮廓、材质细节、干净背景和高级布光。',
    remixBackground: '替换背景',
    remixBackgroundDescription: '保留主体，重做背景空间与氛围。',
    remixBackgroundInstruction: '保留主体外观和比例，重新设计背景空间，使画面更干净、更有层次，并保持真实光影匹配。',
    noSelectionTitle: '请选择一张结果图',
    noSelectionDescription: '选中后可以复制 Prompt、设为参考图，或套用二创动作。',
    recentHistory: '最近生成',
    clearHistory: '清空历史',
    noKeyTitle: '暂无可用于生图的 API Key',
    noKeyDescription: '仅展示启用状态、OpenAI 平台、且分组已开通生图功能的 Key。请创建或切换到符合条件的分组。',
    goKeys: '去管理 API Key',
    auto: '自动',
    qualityLow: '低',
    qualityMedium: '中',
    ...
    referenceSet: '已设为参考图',
    referenceSetFailed: '设置参考图失败',
    unsupportedType: '{name} 的文件类型不支持',
    tooLarge: '{name} 超过 {maxMB}MB',
    fileValidationFailed: '参考图校验失败'
  },
  ...
  usage: {
    ...
    errors: {
      ...
      cleanupConfirmTitle: '清理错误请求',
      cleanupConfirmMessage: '确定清理当前筛选条件和时间范围内的错误请求吗？',
      cleanupSuccess: '已清理 {count} 条错误请求',
      cleanupFailed: '清理错误请求失败',
      categories: {
  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        kiroOauth: 'Google / GitHub / AWS Builder ID / 导入',
      ...
      oauth: {
        ...
        kiro: {
          ...
          oauthTitle: 'OAuth 授权',
          oauthSubtitle: '浏览器授权登录 Kiro',
          oauthProviderTitle: '登录方式',
          ...
          clientIdPlaceholder: '粘贴 IDC client_id',
          clientSecretLabel: 'Client Secret',
          clientSecretPlaceholder: '粘贴 IDC client_secret',
          idcRefreshTokenHint: 'IDC Refresh Token 需要同时提供设备注册得到的 client_id 和 client_secret；Start URL 与 Region 会随请求一并提交。',
          ...
          refreshTokenAuth: '手动输入 RT',
          refreshTokenDesc: '输入您已有的 Kiro Refresh Token，支持批量输入（每行一个），系统将自动验证并创建 OAuth 账号。',
