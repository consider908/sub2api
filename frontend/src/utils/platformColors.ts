...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  grok: 'bg-gradient-to-r from-slate-500 to-zinc-500',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  grok: 'bg-slate-600 text-white hover:bg-slate-700 active:bg-slate-800 dark:bg-slate-500/80 dark:hover:bg-slate-500',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  grok: 'from-slate-500 to-zinc-600',
}
