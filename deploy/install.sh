...
main() {
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo "  $0 install -v 0.1.140-2   # Install specific version"
            echo "  $0 upgrade                # Upgrade to latest"
            echo "  $0 upgrade -v 0.1.140-2   # Upgrade to specific version"
            echo "  $0 rollback 0.1.140-2     # Rollback to 0.1.140-2"
